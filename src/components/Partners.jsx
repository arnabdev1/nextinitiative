  ...
  return (
    <div className="partners bg-zinc-900 rounded-t-3xl flex flex-col items-center">
      <div className="align-center items-center justify-center flex w-full px-10 py-10">
        <h1 className='text-3xl md:text-5xl font-["Neue_Montreal"] font-bold tracking-tight'>
          Our Partners
        </h1>
      </div>
      <hr color="#ffffff" className="w-[80vw] opacity-30"></hr>

      <div className="w-full h-auto py-5 px-10 gap-10 flex lg:flex-row  md:flex-col sm:flex-col flex-col align-middle items-center">
